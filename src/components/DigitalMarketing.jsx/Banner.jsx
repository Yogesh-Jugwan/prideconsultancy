...
const Banner = () => {
  return (
    ...
    <div className="video">
      <img className="lazy" src="assets/frameworks/public/images/web-app-development/web-app-development-banner.jpg" alt="Bespoke custom web development company in the UK, since inception, we are offering tailored web application development solutions for large business and startups." width={1920} height={800} />
    </div>
    <div className="tenc-intro-main__wrapper">
      <div className="container">
        <div className="row align-items-center">
          <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <h1>Digital Marketing CUSTOM WEB DEVELOPMENT COMPANY</h1>
